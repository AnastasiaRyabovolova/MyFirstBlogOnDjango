...
class Board(models.Model):
    name = models.CharField(max_length=30)
    subject = models.ForeignKey(Subject, related_name='boards', default=None, on_delete=models.CASCADE)
    description = models.CharField(max_length=100)
    creater = models.ForeignKey(User, related_name='boards', default=None, on_delete=models.CASCADE)
...
class Action(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    board = models.ForeignKey(Board, null=True, related_name='actions', on_delete=models.CASCADE)
