...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('add', 'create'), ('del', 'delete'), ('edt', 'edit')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', models.ManyToManyField(default=None, to='boards.Subject')),
            ],
        ),
        migrations.AddField(
            model_name='topic',
        ...
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='boards.Country'),
        ),
        migrations.AddField(
            model_name='board',
            name='creater',
        ...
        migrations.AddField(
            model_name='board',
            name='subject',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='boards', to='boards.Subject'),
        ),
        migrations.AddField(
            model_name='action',
            name='board',
